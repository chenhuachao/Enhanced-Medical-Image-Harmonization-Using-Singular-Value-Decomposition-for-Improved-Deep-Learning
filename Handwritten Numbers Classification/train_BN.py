...
def train(model, loss_func, optimizer, checkpoints, epoch):
    ...
    for epoch in range(1, epoch):
        ...
        # 计算每个epoch的训练和验证准确率
        train_acc_epoch = train_accuracy / train_data_size
        val_acc_epoch = val_accuracy / val_data_size
    ...
    # 保存最后的模型
    # 保存模型的时候
    torch.save({'state_dict': model.state_dict()}, checkpoints + '/last.pt')
    ...
    plt.savefig("USPS_2024_har_new.png")
    plt.show()
...
if __name__ == '__main__':
    ...
    epoch = 50
    # checkpoints,模型保存路径
    checkpoints = '/home/gem/Harry/USPS_2024_har_new/checkpoints'
    ...
    base_dir = '/home/gem/Harry/USPS/usps_SVD_Har_2024/train'
    imgs = []
    # 获取数据
    for label in labels:
