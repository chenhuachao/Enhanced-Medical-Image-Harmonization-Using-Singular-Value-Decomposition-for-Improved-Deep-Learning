...
re_img = har_onechannel2.imgHandle(ref_img)
...
for file in files:
    if file == ".DS_Store":
        continue
    print(in_path + file)
    in_img = har_onechannel2.imgHandle(in_path + file)
    out_img = har_onechannel2.imgMerge(in_img, re_img)
